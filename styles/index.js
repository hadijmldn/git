const styles = {
  ...
  // hero section
  heroHeading:
      'font-bold py-2 lg:text-[90px] md:text-[90px] sm:text-[60px] text-[44px] lg:leading-[158.4px] md:leading-[114.4px] sm:leading-[74.4px] leading-[64.4px] text-secondary-white',
  heroDText:
